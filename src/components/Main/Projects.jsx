           ...
           <h1 className="text-white text-3xl font-bold text-center hover:text-yellow-400">My Portfolio</h1>
            ...
            <div className='py-4'>
                <div className="flex flex-col lg:flex-row justify-between py-6">
                    <section className="text-white py-12 max-w-[100%] overflow-x-hidden lg:py-36 tilt-in-left-2 border-l-8 border-t-8 border-solid border-[#139504] p-4">
                    ...
                    <a href='https://movie-world-bay.vercel.app/' target="_blank" className="border-r-8 border-b-8 border-solid border-[#139504] p-4 max-w-[100%] overflow-x-hidden lg:w-[50%] tilt-in-right-2">
                        <img src={movie} alt="Movie" className='lg:py-12 w-full'/>
                    </a>
                </div>
                <div className="flex flex-col lg:flex-row-reverse justify-between py-6">
                    <section className="text-white py-12 max-w-[100%] overflow-x-hidden lg:py-20 tilt-in-left-2 border-l-8 border-t-8 lg:border-r-8 lg:border-b-8 lg:border-l-0 lg:border-t-0 border-solid border-[#139504] p-4">
                        <h2 className="text-3xl font-bold mb-4 text-center lg:text-left hover:text-yellow-400">Project Highlights</h2>
                    ...
                    <a href='https://cosmetics-site-bay.vercel.app/' target="_blank" className="flex p-4 max-w-[100%] overflow-x-hidden border-r-8 border-b-8 lg:border-l-8 lg:border-t-8 border-solid lg:border-r-0 lg:border-b-0 border-[#139504] lg:w-[50%] tilt-in-right-2">
                        <img src={cosmetics} alt="Cosmetics" className='py-12 w-full'/>
                    </a>
                </div>
                <div className="flex flex-col lg:flex-row justify-between py-6">
                    <section className="text-white py-12 max-w-[100%] overflow-x-hidden lg:py-20 tilt-in-left-2 border-l-8 border-t-8 border-solid border-[#139504] p-4">
                        <h2 className="text-3xl font-bold mb-4 text-center lg:text-left hover:text-yellow-400">Project Highlights</h2>
                        <ul className="lg:list-disc pl-6 space-y-2 text-lg/7 text-center lg:text-left">
                    ...
                    <a href='https://apple-green-two.vercel.app/' target="_blank" className="max-w-[100%] overflow-x-hidden lg:w-[50%] tilt-in-right-2 border-r-8 border-b-8 border-solid border-[#139504] p-4">
                ...
                <div className="flex flex-col lg:flex-row-reverse justify-between py-6">
                    ...
                    <a href='https://medical-nine-beta.vercel.app/' target="_blank" className="max-w-[100%] overflow-x-hidden p-4 border-r-8 border-b-8 lg:border-l-8 lg:border-t-8 border-solid lg:border-r-0 lg:border-b-0 border-[#139504] lg:w-[50%] tilt-in-right-2">
