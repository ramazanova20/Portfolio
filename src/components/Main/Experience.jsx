        ...
        <div id="experience" className='pt-24'>
            ...
            <div>
                <div className='py-4'>
                    ...
                    <section className="text-white max-w-[100%] overflow-x-hidden py-12 lg:py-20 tilt-in-left-2 border-l-8 border-t-8 border-solid border-[#139504] p-4">
                    ...
                    <a href='https://migration.gov.az/en' target="_blank" className="lg:w-[50%] max-w-[100%] overflow-x-hidden tilt-in-right-2 border-r-8 border-b-8 border-solid border-[#139504] p-4">
                ...
                <div className='py-4'>
                    ...
                    <a href='https://www.linkedin.com/company/intern-intelligence/posts/?feedView=all' target="_blank" className="flex p-4 border-r-8 border-b-8 lg:border-l-8 lg:border-t-8 border-solid lg:border-r-0 lg:border-b-0 border-[#139504] max-w-[100%] overflow-x-hidden lg:w-[50%] tilt-in-right-2">
