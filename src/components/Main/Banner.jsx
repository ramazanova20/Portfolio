...
function Banner() {
  ...
  return (
    <div>
        ...
        >
            <h1 className='text-8xl font-bold bg-gradient-to-r from-[#139504] to-green-500 text-transparent bg-clip-text'>Hello!</h1>
            <h1 className='text-6xl font-bold bg-gradient-to-r from-[#139504] to-green-500 text-transparent bg-clip-text'>I'm Gunay Ramazanova</h1>
